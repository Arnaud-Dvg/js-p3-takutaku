      ...
      {filteredSeasons.map((season) => (
        <div key={season.id}>
          <button
            ...
            className={`text-tertiary font-semibold border-b-2 transition-colors duration-300
        ${selectedSeason?.id === season.id ? "border-secondary" : "border-transparent hover:border-secondary"}
      `}
          >
